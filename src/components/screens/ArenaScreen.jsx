...
export default function ArenaScreen() {
  ...
  if (!currentQ && !isGameOver) {
    return (
      <motion.div
        className="min-h-screen bg-stone-950 flex flex-col justify-center items-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      >
  ...
  return (
    <motion.div
      className="min-h-screen bg-stone-950 flex flex-col items-center px-4 max-w-sm mx-auto relative overflow-hidden"
